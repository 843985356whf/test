...
<body background="Images/lib8.jpg">
<table width="292" height="175" border="0" cellpadding="0" cellspacing="0" align="center" background="Images/subBG2.jpg">
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td>&nbsp;</td>
        <td><table width="99%%" height="131"  border="0" cellpadding="0" cellspacing="0">
          <tr>
	...
	<table height="100"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        ...
        <td width="198" height="39">
          <input name="typeName" type="text" size="22">        </td>
      </tr>
      <tr>
        <td width="77" align="center">可借天数：</td>
        <td height="35"><input name="days" type="text" id="days" size="22">
          (天)</td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
