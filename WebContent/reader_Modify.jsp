...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <table width="99%" height="510"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F0FFF0" class="tableBorder_gray">
  <tr>
...
<%  int ID=readerForm.getId().intValue();
  ...
  %>
	...
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#F0FFF0">
      <tr>
      ...
      <tr>
        ...
        <td height="39"><input name="barcode" type="text" id="barcode" value="<%=barcode%>" readonly="yes"></td>
      </tr>
      <tr>
...
<%}%> 
      ...
      <tr>
        ...
        <td height="39"><input name="vocation" type="text" id="vocation" value="<%=vocation%>"></td>
      </tr>
      <tr>
        <td align="center">出生日期：</td>
        <td height="39"><input name="birthday" type="text" id="birthday" value="<%=birthday%>"></td>
      </tr>
      <tr>
        <td align="center">有效证件：</td>
        <td height="39"><select name="paperType" class="wenbenkuang" id="paperType">
      ...
      <tr>
        ...
        <td height="39"><input name="paperNO" type="text" id="paperNO" value="<%=paperNO%>"> 
          * </td>
      </tr>
      <tr>
        <td align="center">电&nbsp;&nbsp;&nbsp;&nbsp;话：</td>
        <td height="39"><input name="tel" type="text" id="tel" value="<%=tel%>"></td>
      </tr>
      <tr>
        <td align="center">Email：</td>
        <td height="39"><input name="email" type="text" id="email" value="<%=email%>" size="50">
          <input name="operator" type="hidden" id="operator" value="<%=operator%>"></td>
      </tr>
      <tr>
        <td height="30" align="center">操&nbsp;作&nbsp;员：</td>
        <td height="39"><input name="operator" type="text" id="operator" value="<%=operator%>" readonly="yes">
        </td>
      </tr>
      <tr>
