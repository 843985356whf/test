...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
	...
	<form name="form1" method="post" action="borrow.do?action=bookborrow">
      <tr>
        <td height="47" background="Images/borrowBackRenew2.gif">&nbsp;</td>
      </tr>
      <tr>
        <td height="72" align="center" valign="top" background="Images/main_booksort_12.gif" bgcolor="#F8BF73"><table width="96%" border="0" cellpadding="1" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#F8BF73">
          <tr>
...
%>
               ...
               <tr>
                 <td height="32" background="Images/borrow_if2.gif">&nbsp;添加的依据：
...
<input name="inputkey" type="text" id="inputkey" size="50">
  ...
  <input name="Button" type="button" class="btn_grey" value="完成借阅" onClick="window.location.href='bookBorrow.jsp'">
          ...
          <tr>
            <td valign="top" bgcolor="#F0FFF0" style="padding:5px"><table width="99%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#F6B83B" bgcolor="#FFFFFF">
