	...
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#F0FFF0">
      <tr>
        ...
        <td width="427" height="39">
          <input name="barcode" type="text" id="barcode" value="<%=barcode%>" size="40"></td>
      </tr>
      <tr>
        <td align="center">图书名称：</td>
        <td height="39"><input name="bookName" type="text" id="bookName" value="<%=bookname%>" size="40">
          * </td>
      </tr>
      <tr>
...
<%}%> 
      ...
      <tr>
        ...
        <td><input name="translator" type="text" id="translator" value="<%=translator%>" size="40"></td>
      </tr>
      <tr>
...
<%}%> 
      ...
      <tr>
        ...
        <td><input name="price" type="text" id="price" value="<%=price%>" size="40"> 
          (元) * </td>
      </tr>
      <tr>
        <td align="center">页码：</td>
        <td><input name="page" type="text" id="page" value="<%=pages%>" size="40"></td>
      </tr>
      <tr>
