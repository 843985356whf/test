...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <table width="98%" height="38"  border="0" cellpadding="0" cellspacing="0" bgcolor="#B0C4DE" class="tableBorder_gray">
  <tr>
    <td align="center" bgcolor="#B0C4DE">

&nbsp;<img src="Images/search2.gif" width="45" height="28"></td>
    <td bgcolor="#B0C4DE">请选择查询依据：
...
%>
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="17%" bgcolor="#B0C4DE">条形码</td>  
    <td width="31%" bgcolor="#B0C4DE">图书名称</td>
    <td width="18%" bgcolor="#B0C4DE">图书类型</td>
    <td width="19%" bgcolor="#B0C4DE">出版社</td>
    <td width="15%" bgcolor="#B0C4DE">书架</td>
    </tr>
<%
  while(it.hasNext()){
