...
%>
  ...
  <tr>
    <td>
      <a href="#" onClick="window.open('manager_add.jsp','','width=584,height=350')">添加管理员信息</a> </td>
  </tr>
</table>
 <%
}else{
...
<td width="16%">
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="26%" bgcolor="#B0C4DE">管理员名称</td>
    <td width="12%" bgcolor="#B0C4DE">系统设置</td>
    <td width="12%" bgcolor="#B0C4DE">读者管理</td>
    <td width="12%" bgcolor="#B0C4DE">图书管理</td>
    <td width="11%" bgcolor="#B0C4DE">图书借还</td>
    <td width="10%" bgcolor="#B0C4DE">系统查询</td>
    <td width="9%" bgcolor="#B0C4DE">权限设置</td>
    <td width="8%" bgcolor="#B0C4DE">删除</td>
  </tr>
<%
  while(it.hasNext()){
  ...
  <tr>
    ...
    <td align="center"><%if(!name.equals("manager")){ %><a href="#" onClick="window.open('manager.do?action=managerModifyQuery&id=<%=ID%>','','width=584,height=350')">权限设置</a><%}else{%>&nbsp;<%}%></td>
    <td align="center">
	<%if(!name.equals("manager")){ %><a href="manager.do?action=managerDel&id=<%=ID%>">删除</a><%}else{%>&nbsp;<%}%></td>
  </tr>
<%
  }
}
