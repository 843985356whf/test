...
%>
  ...
  <tr>
    <td>
      <a href="#" onClick="window.open('readerType_add.jsp','','width=584,height=350')">添加读者类型信息</a> </td>
  </tr>
</table>
 <%
}else{
 ...
 <table width="91%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="35%" bgcolor="#B0C4DE">读者类型名称</td>
    <td width="35%" bgcolor="#B0C4DE">可借数量</td>
...
<%
  ...
  <tr>
    ...
    <td align="center"><a href="#" onClick="window.open('readerType.do?action=readerTypeModifyQuery&ID=<%=ID%>','','width=584,height=350')">修改</a></td>
