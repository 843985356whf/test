...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td valign="top" bgcolor="#FFFFFF"><table width="99%" height="510"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F0FFF0" class="tableBorder_gray">
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<form name="myform" method="post" action="borrow.do?action=borrowQuery">
          <table width="98%" height="67"  border="0" cellpadding="0" cellspacing="0" bgcolor="#B0C4DE" class="tableBorder_gray">
            <tr>
              <td rowspan="2" align="center" bgcolor="#B0C4DE">&nbsp;<img src="Images/search2.gif" width="45" height="28"></td>
              <td height="29" bgcolor="#B0C4DE"><input name="flag" type="checkbox" class="noborder" value="a" checked>
                请选择查询依据：
...
%>
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="11%" bgcolor="#B0C4DE">图书条形码</td>
    <td width="29%" bgcolor="#B0C4DE">图书名称</td>
    <td width="15%" bgcolor="#B0C4DE">读者条形码</td>
    <td width="13%" bgcolor="#B0C4DE">读者名称</td>
    <td width="12%" bgcolor="#B0C4DE">借阅时间</td>
    <td width="12%" bgcolor="#B0C4DE">应还时间</td>
    <td width="8%" bgcolor="#B0C4DE">是否归还</td>
  </tr>
<%
  while(it.hasNext()){
