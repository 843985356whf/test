...
<td width="13%">
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="13%" bgcolor="#B0C4DE">条形码</td>  
    <td width="10%" bgcolor="#B0C4DE">姓名</td>
    <td width="8%" bgcolor="#B0C4DE">读者类型</td>
    <td width="12%" bgcolor="#B0C4DE">证件类型</td>
    <td width="20%" bgcolor="#B0C4DE">证件号码</td>
    <td width="12%" bgcolor="#B0C4DE">电话</td>
    <td width="15%" bgcolor="#B0C4DE">Email</td>
    <td width="5%" bgcolor="#B0C4DE">修改</td>
    <td width="5%" bgcolor="#B0C4DE">删除</td>
  </tr>
<%
  while(it.hasNext()){
