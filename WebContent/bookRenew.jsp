...
<body onLoad="clockon(bgclock)" background="Images/lib12.jpg">
<%@include file="banner.jsp"%>
<%@include file="navigation.jsp"%>
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" height="509"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F0FFF0" class="tableBorder_gray">
  <tr>
  ...
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="47" background="Images/borrowBackRenew_r2.gif">&nbsp;</td>
      </tr>
      <tr>
        <td height="72" align="center" valign="top" background="Images/main_booksort_12.gif" bgcolor="#F8BF73"><table width="96%" border="0" cellpadding="1" cellspacing="1" bordercolor="#F8BF73">
          <tr>
...
%>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F0FFF0">
				<form name="form1" method="post" action="borrow.do?action=bookrenew">
                  ...
                  <tr>
                    <td><table width="90%" height="21" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="24%" height="18" style="padding-left:7px;padding-top:7px;"><img src="Images/reader_checkbg2.jpg" width="142" height="18"></td>
                  ...
                  <tr>
                    <td height="13" align="left" style="padding-left:7px;"><hr width="99%" size="1"></td>
                    </tr>
                  <tr>
          ...
          <tr>
            <td valign="top"><table width="100%" height="35" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#F6B83B" bgcolor="#F0FFF0">
                <tr align="center" bgcolor="#e3F4F7">
                  <td width="24%" height="25" bgcolor="#B0C4DE">图书名称</td>
                  <td width="12%" bgcolor="#B0C4DE">借阅时间</td>
                  <td width="13%" bgcolor="#B0C4DE">应还时间</td>
                  <td width="14%" bgcolor="#B0C4DE">出版社</td>
                  <td width="12%" bgcolor="#B0C4DE">书架</td>
                  <td bgcolor="#B0C4DE">定价(元)</td>
                  <td width="12%" bgcolor="#B0C4DE"><input name="Button22" type="button" class="btn_grey" value="完成续借" onClick="window.location.href='bookRenew.jsp'"></td>
                </tr>
<%
int id=0;
String bookname="";
...
%>
      ...
      <tr>
        <td height="19" background="Images/main_booksort_22.gif">&nbsp;</td>
      </tr>
    </table></td>
  </tr>
</table>
