...
%>
 ...
 <table width="98%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#F6B83B" bordercolorlight="#FFFFFF">
  ...
  <td width="8%" bgcolor="#B0C4DE">借阅次数</td>
    <td width="11%" bgcolor="#B0C4DE">图书条形码</td>
    <td width="17%" bgcolor="#B0C4DE">图书名称</td>
    <td width="15%" bgcolor="#B0C4DE">图书类型</td>
    <td width="16%" bgcolor="#B0C4DE">书架</td>
    <td width="14%" bgcolor="#B0C4DE">出版社</td>
    <td width="11%" bgcolor="#B0C4DE">作者</td>
    <td colspan="2" bgcolor="#B0C4DE">定价(元)</td>
    </tr>
<%
  while(it.hasNext()){
